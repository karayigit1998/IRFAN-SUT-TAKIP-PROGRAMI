...
<head>
    ...
    <!-- Custom-Files -->
    <link href="web 2/css/bootstrap.css" rel='stylesheet' type='text/css' />
    <!-- Bootstrap-CSS -->
...
<body>
    ...
    <header>
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-2 px-sm-2 px-1">
                <!-- logo -->
                <div id="logo">
                    <h1><a href="index.html">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; SÜT TAKİP PROGRAMI AYLIK GRAFİĞİ</a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
    ...
    <div class="main-w3pvt mian-content-wthree text-center" id="home">
        <div class="container">
            <div class="style-banner mx-auto">
                <p class="mt-3 text-li" id="join">Join </p>
                <!-- form -->
    ...
    <section class="w3ls-bnrbtm py-5" id="about">
        <div class="container py-xl-5 py-lg-3">
            <h3 class="title-w3 mb-md-5 mb-sm-4 mb-2 text-center font-weight-bold">&nbsp;</h3>
            <div class="row">
            ...
            <div class="row w3pvtits-services-row text-center">
                ...
                <div class="col-lg-4 serv-w3mk mt-5">
                    <div class="w3pvtits-services-grids">
                        ...
                        <h4 class="text-bl my-4">Full Day Programs >
